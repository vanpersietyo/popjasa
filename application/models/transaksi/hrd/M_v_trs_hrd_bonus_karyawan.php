...
class M_v_trs_hrd_bonus_karyawan extends CI_Model
{
//Models
    ...
    const TABLE = "v_trs_hrd_bonus_karyawan";
...
//for inisialisasi.
    ...
    var $table = 'v_trs_hrd_bonus_karyawan';
	...
	/**
	 * @param int $id
	 * @return bool|M_v_trs_hrd_bonus_karyawan
	 */
	 ...
	 * @param array $order
	 * @return array|bool|M_v_trs_hrd_bonus_karyawan
	 */
	...
	/**
	 * @param array $data
	 * @return array | M_v_trs_hrd_bonus_karyawan
	 */
