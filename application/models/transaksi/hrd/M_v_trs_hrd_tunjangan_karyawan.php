...
class M_v_trs_hrd_tunjangan_karyawan extends CI_Model
{
//Models
    const id_trans_tunjangan = "id_trans_tunjangan";
    const id_tunjangan = "id_tunjangan";
    ...
    const nm_tunjangan = "nm_tunjangan";
    const keterangan_tunjangan = "keterangan_tunjangan";
    ...
    const TABLE = "v_trs_hrd_tunjangan_karyawan";

//for inisialisasi.
    public $id_trans_tunjangan;
    public $id_tunjangan;
    public $id_karyawan;
    public $periode;
    public $jumlah;
    ...
    var $table = 'v_trs_hrd_tunjangan_karyawan';
    var $primary_key = 'id_trans_tunjangan';
	...
	/**
	 * @param int $id
	 * @return bool|M_v_trs_hrd_tunjangan_karyawan
	 */
	 ...
	 * @param array $order
	 * @return array|bool|M_v_trs_hrd_tunjangan_karyawan
	 */
	...
	/**
	 * @param array $data
	 * @return array | M_v_trs_hrd_tunjangan_karyawan
	 */
