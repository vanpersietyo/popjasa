...
class M_trs_hrd_bonus_karyawan extends CI_Model
{
//Models
    const id_bonus_krywn = "id_bonus_krywn";
    const id_karyawan = "id_karyawan";
    const periode = "periode";
    const jumlah_bonus = "jumlah_bonus";
    const keterangan = "keterangan";
    const tgl_input = "tgl_input";
    const input_by = "input_by";
    const st_data = "st_data";
    const TABLE = "trs_hrd_bonus_karyawan";

//for inisialisasi.
    public $id_bonus_krywn;
    public $id_karyawan;
    public $periode;
    public $jumlah_bonus;
    public $keterangan;
    ...
    var $table = 'trs_hrd_bonus_karyawan';
    var $primary_key = 'id_bonus_krywn';
	...
	/**
	 * @param int $id
	 * @return bool|M_trs_hrd_bonus_karyawan
	 */
	...
	/**
	 * @param array $data
	 * @return CI_DB | M_trs_hrd_bonus_karyawan
	 */
	...
	/**
	 * @param array $data
	 * @return array | M_trs_hrd_bonus_karyawan
	 */
	 ...
	 * @param array $order
	 * @return array|bool|M_trs_hrd_bonus_karyawan
	 */
