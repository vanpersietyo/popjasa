...
class M_pembayaran_karyawan extends CI_Model {
  ...
  function count_filtered_history($id)
    ...
    // var_dump($data);
    // exit();
    $this->db->insert('trs_hrd_pembayaran_karyawan', $data_insert);
	...
	{
		$this->db->update('trs_hrd_pembayaran_karyawan', $data, $where);
		return $this->db->affected_rows();
	}

	public function delete_by_id($id)
	{
		$this->db->where('id_pmbyrn_krywn', $id);
		$this->db->delete('trs_hrd_pembayaran_karyawan');
