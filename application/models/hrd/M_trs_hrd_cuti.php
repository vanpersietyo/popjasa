...
class M_trs_hrd_cuti extends CI_Model
{
//Models
    const id_cuti = "id_cuti";
    const id_karyawan = "id_karyawan";
    const jns_cuti = "jns_cuti";
    const tgl_cuti = "tgl_cuti";
    const tgl_cuti2 = "tgl_cuti2";
    const keterangan = "keterangan";
    const st_konfirmasi = "st_konfirmasi";
    const konfirmasi_by = "konfirmasi_by";
    const jml_cuti = "jml_cuti";
    const tgl_input = "tgl_input";
    const operator = "operator";
    const TABLE = "trs_hrd_cuti";
...
//for inisialisasi.
    ...
    public $tgl_cuti2;
    public $keterangan;
    public $st_konfirmasi;
    public $konfirmasi_by;
    public $jml_cuti;
    public $tgl_input;
    public $operator;

    var $table = 'trs_hrd_cuti';
    var $primary_key = 'id_cuti';
	 ...
	 * @param array $order
	 * @return array|bool|M_trs_hrd_cuti
	 */
