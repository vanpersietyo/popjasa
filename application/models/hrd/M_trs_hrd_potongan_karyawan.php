...
class M_trs_hrd_potongan_karyawan extends CI_Model
{
//Models
    ...
    const TABLE = "trs_hrd_potongan_karyawan";
...
//for inisialisasi.
    ...
    var $table = 'trs_hrd_potongan_karyawan';
	...
	/**
	 * @param int $id
	 * @return bool|M_trs_hrd_potongan_karyawan
	 */
	...
	/**
	 * @param array $data
	 * @return CI_DB | M_trs_hrd_potongan_karyawan
	 */
	...
	/**
	 * @param array $data
	 * @return array | M_trs_hrd_potongan_karyawan
	 */
	 ...
	 * @param array $order
	 * @return array|bool|M_trs_hrd_potongan_karyawan
	 */
