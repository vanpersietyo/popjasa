                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="nama_kota" placeholder="Nama Kota .." class="form-control" maxlength="50" type="TEXT">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label class="control-label">Nama Kota</label>
                                        <input name="nama_kota" placeholder="Nama Kota .." class="form-control" maxlength="50" type="TEXT" disabled>
