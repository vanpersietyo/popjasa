...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('master/kota/ajax_data')?>",
                "type": "POST"
            },
        });
    ...
    function add_person()
    {
        ...
        $('.modal-title').text('Tambah Kota Baru'); // Set Title to Bootstrap modal title
    ...
    function lookup(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('View Nama Kota'); // Set title to Bootstrap modal title
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                alert('Error get data from ajax');
    ...
    {
        $('[name="id_kota"]').removeClass('border-danger');
        $('[class="NOTIF_ERROR_id_kota"]').html('');
