    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Produk Jasa Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/produkjasa/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/produkjasa/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/produkjasa/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/produkjasa/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/produkjasa/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal-body">
          <form action="#" id="form" class="form-horizontal">
                     ...
                     <div class="form-body">
                         <div class="form-group">
                            <div class="row">
                             <label class="control-label col-md-3">Nama Produk jasa</label>
                             <div class="col-md-12">
                                 <input name="nama_layanan" placeholder="Nama Produk Jasa .." class="form-control" type="text">
                             ...
                             <div class="row">
                               <div class="col-md-12">
                                <label>Jenis Produk Jasa</label>
                                   <input name="jenis_layanan" placeholder="Jenis Produk Jasa .." class="form-control" type="text">
                                   <span class="help-block"></span>
                               </div>
