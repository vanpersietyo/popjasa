  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title success"> Master - Agen</h3>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Agen Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/agen/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/agen/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="nm_agen"]').val(data.nm_agen);
            $('[name="email_agen"]').val(data.email_agen);
            $('[name="telp_agen"]').val(data.telp_agen);
            $('[name="hp_agen"]').val(data.hp_agen);
            $('[name="alamat_agen"]').val(data.alamat_agen);
            $('[name="keterangan"]').val(data.keterangan);
            $('[name="id_agen"]').val(data.id_agen);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/agen/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/agen/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/agen/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
          ...
          <form action="#" id="form" class="form-horizontal">
                     ...
                     <div class="form-body">
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-12">
                               <p class="control-label col-md-5"><b>Name Agen</b></p>
                                 <input name="nm_agen" placeholder="Nama Agen ..." class="form-control" type="text">
                                 <span class="help-block"></span>
                             </div>

                             <div class="col-md-12">
                                  <p class="control-label col-md-5"><b>Email</b></p>
                                 <input name="email_agen" placeholder="Email Agen ..." class="form-control" type="email">
                                 <span class="help-block"></span>
                             </div>
                              ...
                              <div class="col-md-6">
                                <p class="control-label col-md-5"><b>Telp</b></p>
                                  <input name="telp_agen" placeholder="Telp Agen ..." class="form-control" type="number">
                                  <span class="help-block"></span>
                              </div>

                              <div class="col-md-6">
                                  <p class="control-label col-md-5"><b>HP (Hand Phone)</b></p>
                                  <input name="hp_agen" placeholder="Hp Agen ..." class="form-control" type="number">
                                  <span class="help-block"></span>
                              </div>
                             ...
                             <div class="col-md-12">
                               <p class="control-label col-md-5"><b>Alamat</b></p>
                                  <textarea class="form-control" name="alamat_agen" rows="2" placeholder="Alamat .."></textarea>
                                 <span class="help-block"></span>
                             </div>
