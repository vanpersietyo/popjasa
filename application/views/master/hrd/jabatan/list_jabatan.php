    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Jabatan Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/hrd/jabatan/ajax_list')?>",
            "type": "POST"
        },
...
{
    $('[name="nama_jabatan"]').removeClass('border-danger');
    $('[name="id_jabatan"]').removeClass('border-danger');
    $('[class="NOTIF_ERROR_nama_jabatan"]').html('');
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/hrd/jabatan/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/hrd/jabatan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/hrd/jabatan/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Anda Yakin Akan Menghapus Data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/hrd/jabatan/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-md-12">
                                 <input name="nama_jabatan" placeholder="Nama Jabatan .." class="form-control" type="text">
                                  <div class="NOTIF_ERROR_nama_jabatan"></div>
                             </div>
