  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Rekapitulasi Piutang Karyawan (<?php echo $get_karyawan->nama_karyawan;?>)</h3>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-4">
        <div class="form-group">
          <a class="btn mb-1 btn-danger btn-lg btn-block pull-up" href="<?php echo site_url('master/hrd/piutang_karyawan')?>"> Kembali</a>
        </div>
      </div>
    </div>
