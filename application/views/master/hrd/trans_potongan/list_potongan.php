<?php $this->load->view('master/hrd/trans_potongan/assets/css')?>
<!-- END Custom CSS-->
  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Potongan Karyawan</h3>
        </div>
      </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <?php }elseif ($conf->st_data==1) { ?>
                    <div class="col-md-12">
                        <a type="button" href="<?php echo site_url('master/hrd/trans_potongan/unkonfirmasi/'.$this->session->userdata('yangLogin'));?>" class="btn mb-1 btn-warning box-shadow-2 btn-lg btn-block pull-up"> Edit</a>
                    </div>
                  <?php } ?>
...
<?php $this->load->view('master/hrd/trans_potongan/assets/js')?>
<?php $this->load->view('master/hrd/trans_potongan/assets/modal')?>
