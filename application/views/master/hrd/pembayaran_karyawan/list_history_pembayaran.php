  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Rekapitulasi Pembayaran Karyawan (<?php echo $get_karyawan->nama_karyawan;?>)</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><p class="danger">Modul ini di gunakan untuk mencatatat rekapitalasi karyawan yang mempunyai hutang kepada POPJASA</p>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-4">
        <div class="form-group">
          <a class="btn mb-1 btn-danger btn-lg btn-block pull-up" href="<?php echo site_url('master/hrd/pembayaran_karyawan')?>"> Kembali</a>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <!-- Invoices List table -->
                <h2 class="text-center text-red">REKAP KASBON <?php echo strtoupper($get_karyawan->nama_karyawan);?></h2>
                <div class="table-responsive">
                  <table id="table" class="table table-striped table-bordered sourced-data">
                    ...
                    <tfoot>
                      <tr>
                          <th colspan="3"><h5 class="text-bold-500" align="right">Total Piutang:<h5></th>
                          <th colspan="3"><h5 class="text-bold-500" align="left"><?php echo number_format($get_karyawan->jml_piutang);?><h5></th>
                      </tr>
                      <tr>
                          <th colspan="3"><h5 class="text-bold-500" align="right">Total Bayar:<h5></th>
                          <th colspan="3"><h5 class="text-bold-500" align="left"><?php echo number_format($get_karyawan->jml_bayar);?><h5></th>
                      </tr>
                      <tr>
                          <th colspan="3"><h5 class="text-bold-500" align="right">Sisa Piutang:<h5></th>
                          <th colspan="3"><h5 class="text-bold-500" align="left"><?php echo number_format($get_karyawan->jml_piutang-$get_karyawan->jml_bayar);?><h5></th>
                      </tr>
                  </tfoot>
                  </table>
                </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/hrd/piutang_karyawan/ajax_history/'.$id)?>",
            "type": "POST"
        },
        ...
        "columns": [
            ...
            { mData: '1' },
            { mData: '2' },
            { mData: '3', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
            { mData: '4' },
            { mData: '5' },
