  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Absensi Karyawan</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><p class="danger">Modul ini di gunakan untuk mencatatat absensi karyawan POPJASA</p>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="col-6">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <h3 class="content-header-title">List Karyawan</h3>
                  <br>
                <!-- Invoices List table -->
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/hrd/absensi_karyawan/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/hrd/absensi_karyawan/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Absensi Karyawan'); // Set title to Bootstrap modal title
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/hrd/absensi_karyawan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/hrd/absensi_karyawan/ajax_update')?>";
    }
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-6">
                             ...
                             <select class="form-control" name="id_jabatan" disabled>
                              ...
                              <div class="col-md-6">
                                <label for="issueinput5">Tgl Absen</label>
                                <input type="text" name="jml_piutang" class="form-control" value="<?php echo date("Y-m-d H:i:s");?>" disabled>
