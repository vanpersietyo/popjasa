            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"><a>
                            <i class="la la-plus"></i> Tambah Rekening Biaya Baru </a></button>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table" class="table table-striped table-bordered sourced-data">
                                        <thead>
                                        <tr>
                                            <th style="width: 30%">Rekening Biaya</th>
                                            <th style="width: 20%">Jenis</th>
                                            <th style="width: 10%">Input Date</th>
                                            <th style="width: 10%">InputBy</th>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="form-group col-6 mb-2">
                                ...
                                <div class='input-group'>
                                    <input type='hidden' class="form-control form-control-lg input-lg"
                                           name="id_rekbiaya"/>
                                    <input type='text' class="form-control form-control-lg input-lg" name="id_rekbiayaa"
                                           min="1" max="99" readonly required=""/>
                                </div>
                            </div>
                            <div class="form-group col-6 mb-2">
                                <label for="projectinput2">Jenis Rekening Biaya</label>
                                <select class="select form-control block" id="responsive_single" name="id_jns_rekbiaya"
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="maxlength-position-inside" maxlength="30" name="nm_rekbiaya" required=""
                        ...
                        <div class="row">
                            <div class="form-group col-12 mb-2">
                                ...
                                <textarea name="keterangan" placeholder="Description"
                                          class="form-control form-control-lg input-lg position-inside-maxlength"
