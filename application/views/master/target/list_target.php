    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Target Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/targetpencapaian/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/targetpencapaian/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="jumlah_target"]').val(data.jumlah_target);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/targetpencapaian/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/targetpencapaian/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/targetpencapaian/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
          ...
          <form action="#" id="form" class="form-horizontal">
                     ...
                     <div class="form-body">
                         <div class="form-group">
                             ...
                             <div class="col-md-12">
                                 <input value="<?php echo date('M Y')?>" class="form-control" type="text" disabled="">
                             ...
                             <div class="col-md-12">
                                 <input name="jumlah_target" class="form-control" type="number" >
                                 <span class="help-block"></span>
                             </div>
