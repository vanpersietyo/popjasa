    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Harga Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/hargalayanan/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/hargalayanan/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="id"]').val(data.id_hrg_layanan);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/hargalayanan/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/hargalayanan/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/hargalayanan/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                     ...
                     <div class="form-body">
                         <div class="form-group">
                            <div class="row">
                             ...
                             <div class="row">
                               <label class="control-label col-md-12">Jumlah Harga</label>
                               <div class="col-md-12">
                                   <input name="harga" placeholder="Jumlah Harga .." class="form-control" type="number">
