    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"><b>Transaksi Kas Keluar</b></h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><p class="dark">Transaksi Untuk Mencairkan Dana Pengeluaran
                                    Dengan Mengurangi Saldo</p>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="float-md-right">
                    <button type="button" class="btn btn-outline-info btn pull-up" onclick="add_person()"><i
                                class="fas fa-plus-circle"></i> <b> Buat Transaksi Kas Keluar</b>
                    </button>
                </div>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="table" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:15%;text-align: right">SALDO KELUAR</th>
