  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Project Baru </a></button>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <a class="btn mb-1 btn-info btn-lg btn-block pull-up" href="<?php echo site_url('transaksi/project')?>"><i class="la la-backward"></i> Kembali</a>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('transaksi/project/ajax_project/'.$id_customer)?>",
            "type": "POST"
        },
