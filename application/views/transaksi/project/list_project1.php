  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Created Project.</h3>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <!-- Invoices List table -->
                  <?php echo form_open('transaksi/project/input_header')?>
                           <div class="form-body">
                               <div class="form-group">
                                  <div class="row">
                                   ...
                                   <div class="row">
                                     ...
                                     <div class="col-md-6">
                                       <div class="form-group">
                                         <button type="submit"  class="btn mb-1 btn-info box-shadow-2 btn-lg btn-block pull-up"> Lanjut Tahap Berikutnya</button>
                                       </div>
                                     </div>
                                     <div class="col-md-6">
                                       <!-- Block level buttons with icon -->
                                       <div class="form-group">
                                         <a href="<?php echo site_url('transaksi/project')?>" class="btn mb-1 btn-danger box-shadow-2 btn-lg btn-block pull-up" data-dismiss="modal">
                                           Batal
                                         </a>
                                       </div>
                                     </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('transaksi/project/ajax_project_produk')?>",
            "type": "POST"
        },
    ...
    table2 = $('#table2').DataTable({
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('transaksi/project/ajax_project/'.$customer->id_customer)?>",
            "type": "POST"
        },
