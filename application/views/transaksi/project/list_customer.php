    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <a  class="btn mb-1 btn-info btn-lg btn-block pull-up" href="<?php echo site_url('transaksi/project/create_new');?>"> <i class="la la-plus"></i> Create Project </a>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <h5 class="text-bold-500" >List Project : </h5>
                <br>
                <!-- Invoices List table -->
