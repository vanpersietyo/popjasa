        ...
        <div class="content-header-left col-md-6 col-12 mb-2" style="padding-bottom: 0 !important;  margin-bottom: 0 !important;">
  			...
  			<div class="content-header-right col-md-6 col-12">
  				<div class="float-md-right">
  					<button class="btn btn-danger bg-accent-4 pull-up" type="button" onclick="window.location.href='<?php echo site_url('transaksi/keuangan/bankout')?>'"><i class="ft-arrow-left white"></i> Kembali</button>
