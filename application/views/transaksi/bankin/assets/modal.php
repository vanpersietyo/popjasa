        ...
        <div class="modal-body">
          <form action="#" id="form" class="form-horizontal" onsubmit="save()">
                             ...
                             <div class="row">
                               ...
                               <div class="col-md-6">
                                 <label class="control-label">Jumlah Saldo Masuk</label>
                                   <input name="SLD_MASUK" placeholder="Jml Saldo Keluar .." id="tanpa-rupiah" class="form-control" type="text">
                               ...
                               <div class="col-6 mb-2">
                                     ...
                                     <div class="input-group">
                                       <div class="input-group-prepend">
                                         <button class="btn btn-info" type="button"><i class="ft-calendar"></i></button>
                                       </div>
                 ...
                 <div class="row">
                   <div class="col-md-6">
                     <div class="form-group">
                       <button type="submit" id="btnSave"  class="btn mb-1 btn-info box-shadow-2 btn-lg btn-block pull-up"> Simpan</button>
                     </div>
                   </div>
                   <div class="col-md-6">
                           ...
                           <div class="row">
                             ...
                             <div class="col-md-12">
                               <label class="control-label">Jumlah Saldo Keluar</label>
                                 <input name="SLD_MASUK" placeholder="Jml Saldo Keluar .." id="tanpa-rupiah2" class="form-control" type="text" readonly>
                                  <div class="NOTIF_ERROR_SLD_MASUK"></div>
                             </div>
                         </div>
                   </div>
