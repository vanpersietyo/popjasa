        ...
        <div class="content-header-left col-md-6 col-12 mb-2">
          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><p class="danger">Berikut merupakan daftar kota untuk masing masing cabang</p>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Area Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('sales/master/area/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Tambah Area Baru'); // Set Title to Bootstrap modal title

}

function clear_all_error()
{
    $('[name="nama_kota"]').removeClass('border-danger');
    $('[class="NOTIF_ERROR_nama_kota"]').html('');
}
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('sales/master/area/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="id"]').val(data.id_kota);
            $('[name="id_kota2"]').val(data.id_kota);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('sales/master/area/ajax_add')?>";
    } else {
        url = "<?php echo site_url('sales/master/area/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Anda Yakin Akan Menghapus Data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('sales/master/area/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#" id="form" class="form-horizontal">
                     ...
                     <div class="form-body">
                         <div class="form-group">
                             <label class="control-label col-md-12">Nama Area Kota</label>
                             <div class="col-md-12">
                                 <input name="nama_kota" placeholder="Nama Area Kota .." class="form-control" type="text">
                                 <input type="hidden" name="id"/>
                                  <div class="NOTIF_ERROR_nama_kota"></div>
                             </div>
        ...
        <div class="modal-body">
                     ...
                     <div class="form-body">
                         <div class="form-group">
                             ...
                             <div class="col-md-12">
                                 <input name="nama_kota" placeholder="Nama Area Kota .." class="form-control" type="text" disabled>
                                 <input type="hidden" name="id"/>
                                  <div class="NOTIF_ERROR_nama_kota"></div>
                             </div>
