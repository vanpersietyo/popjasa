  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Customer Lost</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><p class="danger">Berikut Merupakan daftar customer yang telah lost</p>
                </li>
              </ol>
            </div>
          </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('sales/customer/lost/ajax_list')?>",
            "type": "POST"
        },
...
{
    if(confirm('Apakah Anda Yakin Untuk Di Generate Ke Customer Deal ?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('sales/customer/lost/ajax_deals')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('#modal_form').modal('hide');
                reload_table();
                swal("Good Job !", "Data Berhasil Menjadi Customer Deal !", "success");
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                swal("Upps Sorry !", "Data Gagal Menjadi Customer Deal !", "warning");
            }
        });
                             ...
                             <div class="row">
                               ...
                               <label class="control-label col-md-3">Keterangan Contacted</label>
                                 ...
                                 <label class="control-label col-md-3">Keterangan Lost</label>
                                   <div class="col-md-12">
                                    <textarea name="keterangan_lost" placeholder="Keterangan .." maxlength="255" class="form-control" type="textarea" disabled></textarea>
                                   </div>
                             </div>
