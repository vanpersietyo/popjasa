  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Customer Contacted</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><p class="danger">Berikut Merupakan daftar customer yang telah tanya tanya</p>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-comments"></i> Customer Contacted </a></button>
        </div>
      </div>
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('sales/customer/contacted/ajax_list')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method === 'add') {
		...
		formData = new FormData($('#form_deal')[0]);
	}else if(save_method === 'lost') {
        url = "<?php echo site_url('sales/customer/contacted/ajax_lost')?>";
		formData = new FormData($('#form_lost')[0]);
	} else if(save_method === 'perbarui') {
        url = "<?php echo site_url('sales/customer/contacted/ajax_perbarui')?>";
