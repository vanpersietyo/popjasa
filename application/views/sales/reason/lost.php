  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title danger"> Master - Lost Reason</h3>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Lost Reason Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/sales/reason/lost/ajax_list')?>",
            "type": "POST"
        },
...
function add_person()
{
    ...
    $('.modal-title').text('Tambah Lost Reason Baru'); // Set Title to Bootstrap modal title
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/sales/reason/lost/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="keterangan"]').val(data.keterangan);
            $('[name="id_reason_lost"]').val(data.id_reason_lost);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/sales/reason/lost/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/sales/reason/lost/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/sales/reason/lost/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#" id="form" class="form-horizontal">
                     <input type="hidden" name="id_reason_lost"/>
                     <div class="form-body">
                         <div class="form-group">
                             <p class="control-label col-md-5"><b>Name Lost Reason</b></p>
                             <div class="col-md-12">
                                 <input name="keterangan" placeholder="Name Lost Reason ..." class="form-control" type="text">
  ...
  aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#" id="form" class="form-horizontal">
                     <input type="hidden" value="" name="itemcategoryid"/>
                     <div class="form-body">
                         <div class="form-group">
                             <label class="control-label col-md-3">ID User</label>
                             <div class="col-md-12">
                                 <input name="id_user" placeholder="Id User .." class="form-control" type="text" disabled>
                                 <span class="help-block"></span>
                             </div>
                            <div class="col-md-12">
                             <label for="issueinput5">Pilih Karyawan</label>
                             <select class="form-control" name="id_karyawan" required>
                                <option value=""> --- </option>
                                <?php foreach ($employe as $em) { ?>
                                  <option value="<?php echo $em->id_karyawan ?>"> <?php echo "$em->nama_karyawan" ?> </option>
                                <?php }?>
                              </select>
                              </div>
                            <!--  <label class="control-label col-md-3">Nama User</label>
                             ...
                             <label class="control-label col-md-3">Pilih Status</label>
                             <div class="col-md-12">
