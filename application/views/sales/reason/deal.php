  ...
  <div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title success"> Master - Deal Reason</h3>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6">
        <div class="form-group">
          <button type="button" class="btn mb-1 btn-info btn-lg btn-block pull-up" onclick="add_person()"> <a> <i class="la la-plus"></i> Tambah Deal Reason Baru </a></button>
        </div>
      </div>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('master/sales/reason/deal/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('master/sales/reason/deal/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            $('[name="keterangan"]').val(data.keterangan);
            $('[name="id_reason_deal"]').val(data.id_reason_deal);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('master/sales/reason/deal/ajax_add')?>";
    } else {
        url = "<?php echo site_url('master/sales/reason/deal/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('master/sales/reason/deal/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="#" id="form" class="form-horizontal">
                     <input type="hidden" name="id_reason_deal"/>
                     <div class="form-body">
                         <div class="form-group">
