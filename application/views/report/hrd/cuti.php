        ...
        <div class="col-xl-12 col-lg-12">
             <div class="card">
               <div class="card-header">
                 <h4 class="card-title">Report Ijin Tidak Hadir Karyawan</h4>
               </div>
               <div class="card-content">
                 <div class="card-body">
                   <p>Berikut Merupakan Laporan Dari Ijin Tidak Hadir Karyawan</p>
                   <ul class="nav nav-tabs nav-underline no-hover-bg">
                     <li class="nav-item">
                       <a class="nav-link" id="home-tab3" data-toggle="tab" href="#home3" aria-controls="home3"
                       aria-expanded="true">Rekapitulasi</a>
                     </li>
                     <li class="nav-item">
                       <a class="nav-link active" id="profile-tab3" data-toggle="tab" href="#profile3" aria-controls="profile3"
                       aria-expanded="false">Per Karyawan</a>
                     </li>
                   ...
                   <div class="tab-content px-1 pt-1">
                     <div role="tabpanel" class="tab-pane" id="home3" aria-labelledby="home-tab3" aria-expanded="true">
                       <form method="post" target="print_popup" action="<?php echo site_url('report/hrd/cuti/cetak') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                         <div class="form-body">
                           <h4 class="form-section"><i class="ft-clipboard"></i> Laporan Ijin Tidak Hadir Semua Karyawan</h4>
                                        <div class="row">
                     ...
                     aria-expanded="false">
                         <form method="post" target="print_popup" action="<?php echo site_url('report/hrd/cuti/cetak_karyawan') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                           <div class="form-body">
                             <h4 class="form-section"><i class="ft-clipboard"></i> Laporan Ijin Tidak Hadir By Karyawan</h4>
                                          <div class="row">
                                            <div class="col-6 mb-2">
                                              <div class="form-group">
                                                  <label for="projectinput2">Tgl Awal</label>
