        ...
        <div class="col-xl-12 col-lg-12">
             <div class="card">
               <div class="card-header">
                 <h4 class="card-title">Report Absensi Karyawan</h4>
               </div>
               <div class="card-content">
                 <div class="card-body">
                   <p>Berikut Merupakan Laporan Dari Absensi Karyawan</p>
                   ...
                   <div class="tab-content px-1 pt-1">
                     <div role="tabpanel" class="tab-pane" id="home3" aria-labelledby="home-tab3" aria-expanded="true">
                       <form method="post" target="print_popup" action="<?php echo site_url('report/hrd/absensi/cetak') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                         <div class="form-body">
                           <h4 class="form-section"><i class="ft-clipboard"></i> Laporan Absensi By Karyawan</h4>
                                        <div class="row">
                     ...
                     aria-expanded="false">
                         <form method="post" target="print_popup" action="<?php echo site_url('report/hrd/absensi/cetak_karyawan') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                           <div class="form-body">
                             <h4 class="form-section"><i class="ft-clipboard"></i> Laporan Absensi By Karyawan</h4>
                                          <div class="row">
                                            <div class="col-6 mb-2">
