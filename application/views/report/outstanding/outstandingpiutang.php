                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Laporan Piutang Customer</h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <p>Berikut Merupakan Laporan Piutang Customer</p>
                                <div>
                                    <form method="post" target="print_popup" action="<?php echo site_url('report/outstandingpiutang/cetak') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-clipboard"></i> Laporan Piutang Customer</h4>
                                            <div class="row">
...
<?php $this->load->view('report/outstanding/js/piutang') ?>
