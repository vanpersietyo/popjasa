                                ...
                                <div class="tab-content px-1 pt-1">
                                    <div role="tabpanel" class="tab-pane" id="home3" aria-labelledby="home-tab3" aria-expanded="true">
                                        <form method="post" target="print_popup" action="<?php echo site_url('report/biayapengeluaran/cetak') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-clipboard"></i> Laporan Biaya Pengeluaran</h4>
                                                <div class="row">
                                    ...
                                    <div class="tab-pane active" id="profile3" role="tabpanel" aria-labelledby="profile-tab3"
                                        ...
                                        <form method="post" target="print_popup" action="<?php echo site_url('report/biayapengeluaran/cetak') ?>" onsubmit="window.open('about:blank','print_popup','width=1000,height=800');">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="submitForm" value="log" class="btn mb-1 btn-info box-shadow-2 btn-lg btn-block pull-up"><i class="la la-print"></i> Cetak</button>
                                            </div>
                                        </form>
                                    </div>
