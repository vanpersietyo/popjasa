  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title mb-0">MONTHLY | 1 January 2018 - 10 January 2018 . 10:00 AM</h3>
    ...
    <div class="content-body">
                  ...
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-white text-left">
                        <h3 class="text-white">250 Order (Customer)</h3>
                ...
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      ...
                      <div class="align-self-center">
                        <i class="la la-cutlery text-white font-large-2 float-right"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      ...
                      <div class="align-self-center">
                        <i class="la la-glass text-white font-large-2 float-right"></i>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section id="charts-section">
        <div class="row">
              ...
              <div class="card bg-info pull-up">
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-white text-left">
                        <h3 class="text-white">Rp 2.500.000</h3>
                        <span>Makan</span>
                      </div>
                      <div class="align-self-center">
                        <i class="la la-glass text-white font-large-2 float-right"></i>
              ...
              <div class="card bg-gradient-directional-info pull-up">
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-white text-left">
                        <h3 class="text-white">Rp 1.500.000</h3>
                        <span>Minum</span>
                      </div>
                      <div class="align-self-center">
                        <i class="la la-glass text-white font-large-2 float-right"></i>
              ...
              <div class="card bg-gradient-directional-info pull-up">
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-white text-left">
                        <h3 class="text-white">Rp 500.000</h3>
                        <span>Snack</span>
                      </div>
                      <div class="align-self-center">
                        <i class="la la-glass text-white font-large-2 float-right"></i>
          ...
          <div class="col-xl-4 col-lg-12">
            <div class="col-xl-12 col-12">
              <div class="card bg-secondary pull-up">
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-white text-left">
        ...
        <div class="row">
          <div id="recent-transactions" class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-header bg-danger">
                <h4 class="card-title" style="color: white;">TOP 10 Produk Makanan Terjual</h4>
                    ...
                    <tbody>
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Tengkleng Sapi</p>
                        </td>
                        <td class="text-truncate">
                          <h3>20</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Tengkleng Kambing</p>
                        </td>
                        <td class="text-truncate">
                          <h3>15</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Tengkleng Ayam</p>
                        </td>
                        <td class="text-truncate">
                          <h3>14</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Tengkleng Kerbau</p>
                        </td>
                        <td class="text-truncate">
                          <h3>10</h3>
                        </td>
          ...
          <div id="recent-transactions" class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-header bg-success bg-darken-1">
                <h4 class="card-title" style="color: white;">TOP 10 Produk Minuman Terjual</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                ...
                <div class="table-responsive">
                  <table id="recent-orders" class="table table-hover table-xl mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Es Teh Jumbo</p>
                        </td>
                        <td class="text-truncate">
                          <h3>20</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Es Lidah Mantan</p>
                        </td>
                        <td class="text-truncate">
                          <h3>15</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Es Coklat</p>
                        </td>
                        <td class="text-truncate">
                          <h3>14</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Es Jeruk</p>
                        </td>
                        <td class="text-truncate">
                          <h3>10</h3>
                        </td>
          ...
          <div id="recent-transactions" class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-header bg-warning bg-darken-1">
                <h4 class="card-title" style="color: white;">TOP 10 Produk Snack Terjual</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                ...
                <div class="table-responsive">
                  <table id="recent-orders" class="table table-hover table-xl mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Ceker</p>
                        </td>
                        <td class="text-truncate">
                          <h3>20</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Kentang</p>
                        </td>
                        <td class="text-truncate">
                          <h3>15</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Onion Ring</p>
                        </td>
                        <td class="text-truncate">
                          <h3>14</h3>
                        </td>
                      ...
                      <tr>
                        <td class="text-truncate">
                          <p style="font-size: 20px;"> Plastik</p>
                        </td>
                        <td class="text-truncate">
                          <h3>10</h3>
                        </td>
              ...
              <div class="card-content">
                <div class="earning-chart position-relative">
                  <div class="chart-title position-absolute mt-2 ml-2">
                    <h1 class="display-4">2.9 Hour</h1>
                    <span class="text-muted">Low Level Issue</span>
                  </div>
                  ...
                  <!-- <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                    <a href="#" class="btn bg-danger mr-1 white">Statistics <i class="ft-bar-chart"></i></a>
          ...
          <div class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-content">
                <div class="earning-chart position-relative">
                  <div class="chart-title position-absolute mt-2 ml-2">
                    <h1 class="display-4">7.3 Hour</h1>
                    <span class="text-muted">Medium Level Issue</span>
                  </div>
                  <canvas id="earning-chart2" class="height-450 block"></canvas>
                  <!-- <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                    <a href="#" class="btn bg-danger mr-1 white">Statistics <i class="ft-bar-chart"></i></a>
                    <span class="text-muted">for the <a href="#" class="danger darken-2">last year.</a></span>
                  </div> -->
          ...
          <div class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-content">
                <div class="earning-chart position-relative">
                  <div class="chart-title position-absolute mt-2 ml-2">
                    <h1 class="display-4">18 Hour</h1>
                    <span class="text-muted">High Issue</span>
                  </div>
                  <canvas id="earning-chart3" class="height-450 block"></canvas>
                  <!-- <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                    <a href="#" class="btn bg-danger mr-1 white">LOW KPI <i class="ft-bar-chart"></i></a>
                    <span class="text-muted">for the <a href="#" class="danger darken-2">last year.</a></span>
                  </div> -->
                </div>
              </div>
          ...
          <div class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-content">
                <div class="earning-chart position-relative">
                  <div class="chart-title position-absolute mt-2 ml-2">
                    <h1 class="display-4">52 Hour Average</h1>
                    <span class="text-muted">Low Level Development</span>
                  </div>
                  <canvas id="earning-chart4" class="height-450 block"></canvas>
                  <!-- <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                    <a href="#" class="btn bg-danger mr-1 white">LOW KPI <i class="ft-bar-chart"></i></a>
                    <span class="text-muted">for the <a href="#" class="danger darken-2">last year.</a></span>
                  </div> -->
          ...
          <div class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-content">
                <div class="earning-chart position-relative">
                  <div class="chart-title position-absolute mt-2 ml-2">
                    <h1 class="display-4">120 Hour Average</h1>
                    <span class="text-muted">Medium Level Development</span>
                  </div>
                  <canvas id="earning-chart5" class="height-450 block"></canvas>
                  <!-- <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                    <a href="#" class="btn bg-danger mr-1 white">LOW KPI <i class="ft-bar-chart"></i></a>
                    <span class="text-muted">for the <a href="#" class="danger darken-2">last year.</a></span>
                  </div> -->
          ...
          <div class="col-xl-4 col-lg-12">
            <div class="card pull-up">
              <div class="card-content">
                <div class="earning-chart position-relative">
                  <div class="chart-title position-absolute mt-2 ml-2">
                    <h1 class="display-4">618 Hour Avg</h1>
                    <span class="text-muted">High Level Development</span>
                  </div>
                  <canvas id="earning-chart6" class="height-450 block"></canvas>
                  <!-- <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                    <a href="#" class="btn bg-danger mr-1 white">LOW KPI <i class="ft-bar-chart"></i></a>
                    <span class="text-muted">for the <a href="#" class="danger darken-2">last year.</a></span>
                  </div> -->
          ...
          <div class="col-12">
            <div class="card pull-up">
              <div class="card-header">
                <h4 class="card-title">IT Jobload</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
              ...
              <div class="card-content collapse show">
                <div class="card-body chartjs">
                  <canvas id="jobload" height="500"></canvas>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="chartjs-bar-charts">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card pull-up">
              <div class="card-header">
                <h4 class="card-title">Case Deparment / Month</h4>
                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
...
(function(window, document, $) {
    ...
    ****************************************************/
    ...
    var ctx1 = document.getElementById("emp-satisfaction2").getContext("2d");
...
(function(window, document, $) {
    ...
    ****************************************************/
    ...
    var empSatData = {
        ...
        datasets: [{
            label: "Employees",
            data: [3.3, 2.8, 3.8, 4, 3.8, 3.6, 3.7],
            backgroundColor: white_gradient,
            borderColor: "rgba(255,255,255,1)",
            borderWidth: 2,
            strokeColor : "#ff6c23",
    ...
    var areaChart = new Chart(ctx1, empSatconfig);
        ...
        **********************************************/
        //Get the context of the Chart canvas element we want to select
        var ctx3 = document.getElementById("earning-chart2").getContext("2d");
...
(function(window, document, $) {
    'use strict';
        ...
        **********************************************/
        //Get the context of the Chart canvas element we want to select
        var ctx3 = document.getElementById("earning-chart3").getContext("2d");
        ...
        **********************************************/
        //Get the context of the Chart canvas element we want to select
        var ctx3 = document.getElementById("earning-chart4").getContext("2d");
        ...
        **********************************************/
        //Get the context of the Chart canvas element we want to select
        var ctx3 = document.getElementById("earning-chart5").getContext("2d");
        ...
        **********************************************/
        //Get the context of the Chart canvas element we want to select
        var ctx3 = document.getElementById("earning-chart6").getContext("2d");
